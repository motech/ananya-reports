...
public class ReportsPurgeServiceIT {
    ...
    private void setUpData() {
        ...
        Subscription subscription1 = new Subscription(msisdnToPurge, subscriber, subscriptionPackDimension, channelDimension, null, dateDimension, "subscriptionId1", now, now, "ACTIVE", null);
        template.save(subscription1);
        Subscription subscription2 = new Subscription(9876543210L, subscriber, subscriptionPackDimension, channelDimension, null, dateDimension, "subscriptionId2", now, now, "ACTIVE", subscription1);
        template.save(subscription2);
        Subscription subscription3 = new Subscription(msisdnToPurge, subscriber, subscriptionPackDimension, channelDimension, null, dateDimension, "subscriptionId3", now, now, "ACTIVE", subscription2);
