...
public class AllSubscriptionStatusMeasureIT extends SpringIntegrationTest {
    ...
    public void shouldAddNewSubscriptionStatusMeasure() {
        ...
        Subscription subscription = new Subscription(1234L, subscriberFromDb, subscriptionPackDimension, channelDimension, null, dateDimension, subscriptionId, DateTime.now(), DateTime.now(), "ACTIVE", null, null, false);
