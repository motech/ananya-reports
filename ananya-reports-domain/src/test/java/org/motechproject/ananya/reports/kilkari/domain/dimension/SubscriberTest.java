...
public class SubscriberTest {
    ...
    public void shouldUpdateSubscriberWithGivenDetails() {
        ...
        Subscriber subscriber = new Subscriber("oldName", 23, DateTime.now().plus(42), DateTime.now().minusYears(3), null, new LocationDimension("D1", "B1", "P1"), null, null);
    ...
    public void shouldUpdateSubscriberWithEddDob() {
        ...
        Subscriber subscriber = new Subscriber("oldName", 23, oldEdd, oldDob, null, new LocationDimension("D1", "B1", "P1"), null, null);
