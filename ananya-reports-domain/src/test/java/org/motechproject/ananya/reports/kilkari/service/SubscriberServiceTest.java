...
public class SubscriberServiceTest {
    ...
    public void shouldDeleteSubscribers() {
        ...
        Subscription subscription1 = new Subscription(1L, subscriber1, subscriptionPackDimension, null, null, null, null, DateTime.now(), DateTime.now(), "NEW", null, null, false);
        subscriptions.add(subscription1);
        Subscription subscription2 = new Subscription(1L, subscriber1, subscriptionPackDimension, null, null, null, null, DateTime.now(), DateTime.now(), "NEW", null, null, false);
