...
public class AllSubscriptionsIT extends SpringIntegrationTest {
    ...
    public void shouldFindBySubscriptionId() {
        ...
        Subscription subscription = new Subscription(subscriber, subscriptionPackDimension, channelDimension,
                operatorDimension, locationDimension, dateDimension, subscriptionId, now, DateTime.now(), subscriptionStatus, weekNumber);
    ...
    public void shouldFindByMsisdn() {
        ...
        int weekNumber = 13;
        String subscriptionStatus = "ACTIVE";
        Subscription subscription1 = new Subscription(subscriber1, subscriptionPackDimension, channelDimension, operatorDimension, locationDimension, dateDimension, subscriptionId1, now, now, subscriptionStatus, weekNumber);
        Subscription subscription2 = new Subscription(subscriber2, subscriptionPackDimension, channelDimension, operatorDimension, locationDimension, dateDimension, subscriptionId2, now, now, subscriptionStatus, weekNumber);
    ...
    public void shouldUpdateAnExistingSubscription() {
        ...
        Subscription subscription = new Subscription(subscriber, subscriptionPackDimension, channelDimension, null, locationDimension, dateDimension, subscriptionId, now, now, "ACTIVE", 13);
