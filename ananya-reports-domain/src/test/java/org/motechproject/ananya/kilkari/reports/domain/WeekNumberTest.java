...
public class WeekNumberTest {
    ...
    public void shouldCalculateWeekNumberBasedOnPackAndReferenceDate() {
        ...
        Integer subscriptionWeekNumber = WeekNumber.getSubscriptionWeekNumber(new Timestamp(startDate.getMillis()), new DateTime(2012, 02, 01, 10, 10), SubscriptionPack.CHOTI_KILKARI.name());
