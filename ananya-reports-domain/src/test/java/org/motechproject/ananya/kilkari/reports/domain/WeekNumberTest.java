...
public class WeekNumberTest {
    ...
    public void shouldCalculateWeekNumberBasedOnPackAndReferenceDate() {
        ...
        Integer subscriptionWeekNumber = WeekNumber.getSubscriptionWeekNumber(startDate, new DateTime(2012, 02, 01, 10, 10), SubscriptionPack.CHOTI_KILKARI.name(), SubscriptionStatus.ACTIVE.name());
