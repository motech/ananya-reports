...
public class SubscriberTest {
    ...
    public void shouldUpdateSubscriberWithGivenDetails() {
        ...
        subscriber.updateWith(new SubscriberRequest(subscriptionId, createdAt, beneficiaryName, beneficiaryAge,
                expectedDateOfDelivery, dateOfBirth, location), new LocationDimension(district, block, panchayat));
        ...
        assertEquals(district, subscriber.getLocationDimension().getDistrict());
        assertEquals(block, subscriber.getLocationDimension().getBlock());
        assertEquals(panchayat, subscriber.getLocationDimension().getPanchayat());
    }
}
