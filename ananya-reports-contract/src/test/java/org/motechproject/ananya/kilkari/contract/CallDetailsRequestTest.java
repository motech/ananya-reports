...
public class CallDetailsRequestTest {
    ...
    public void shouldGetDuration() {
        Integer actualDuration = new CallDetailsRequest("subscriptionId", "9876543210", "1", "HELP", "2", "SUCCESS", new CallDetailRecordRequest(DateTime.now(), DateTime.now().plusMinutes(2)), "OBD").getDuration();
